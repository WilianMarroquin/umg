...
@section('content')
@Auth
 <form action="{{route('dar.servicio')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grupo" style="margin: auto">
            <label for="">Imagen de su Curriculum:</label>
            <label for="file-upload" class="subir">
                <i class="fas fa-cloud-upload-alt"></i> Subir archivo
            </label>
            <input name="curriculum" id="file-upload" onchange='cambiar()' type="file" style='display: none;'/>
            <div id="info"></div>
        </div>
        <div class="grupo">
