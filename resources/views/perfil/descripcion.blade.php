...
@section('content')
 <form action="{{route('editar.descripcion')}}" method="POST" enctype="multipart/form-data">
        @csrf 
        ...
        <div class="grupo">
            ...
            <input type="text" name='preferencia_productos'>
        </div>
        <div class="grupo">
        ...
        <div class="grupo" style="margin: auto; margin-bottom: 20px">
            ...
            <input name="foto" id="file-upload" onchange='cambiar()' type="file" style='display: none;'/>
            <div id="info"></div>
        </div>
        <div class="grupo">
